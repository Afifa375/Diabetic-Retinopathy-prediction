  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "DWB1z233kvmD",
        "outputId": "f532ed53-48b9-4f44-fe89-e89df2615c62"
      },
      "execution_count": 2,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "w9PKSk9rkvjX",
        "outputId": "fe1f69c0-90ad-4164-d46b-ba1a091a5740"
      },
      "execution_count": 3,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Requirement already satisfied: gast!=0.5.0,!=0.5.1,!=0.5.2,>=0.2.1 in /usr/local/lib/python3.12/dist-packages (from tensorflow->-r requirements.txt (line 1)) (0.7.0)\n",
            ...
            "Requirement already satisfied: termcolor>=1.1.0 in /usr/local/lib/python3.12/dist-packages (from tensorflow->-r requirements.txt (line 1)) (3.2.0)\n",
            ...
            "Requirement already satisfied: wrapt>=1.11.0 in /usr/local/lib/python3.12/dist-packages (from tensorflow->-r requirements.txt (line 1)) (2.0.1)\n",
            "Requirement already satisfied: grpcio<2.0,>=1.24.3 in /usr/local/lib/python3.12/dist-packages (from tensorflow->-r requirements.txt (line 1)) (1.76.0)\n",
            ...
            "Requirement already satisfied: h5py>=3.11.0 in /usr/local/lib/python3.12/dist-packages (from tensorflow->-r requirements.txt (line 1)) (3.15.1)\n",
            "Requirement already satisfied: ml-dtypes<1.0.0,>=0.5.1 in /usr/local/lib/python3.12/dist-packages (from tensorflow->-r requirements.txt (line 1)) (0.5.4)\n",
            ...
            "Requirement already satisfied: optree in /usr/local/lib/python3.12/dist-packages (from keras>=3.5.0->tensorflow->-r requirements.txt (line 1)) (0.18.0)\n",
            "Requirement already satisfied: charset_normalizer<4,>=2 in /usr/local/lib/python3.12/dist-packages (from requests<3,>=2.21.0->tensorflow->-r requirements.txt (line 1)) (3.4.4)\n",
            "Requirement already satisfied: idna<4,>=2.5 in /usr/local/lib/python3.12/dist-packages (from requests<3,>=2.21.0->tensorflow->-r requirements.txt (line 1)) (3.11)\n",
            ...
            "Requirement already satisfied: certifi>=2017.4.17 in /usr/local/lib/python3.12/dist-packages (from requests<3,>=2.21.0->tensorflow->-r requirements.txt (line 1)) (2025.11.12)\n",
            ...
            "Requirement already satisfied: markdown>=2.6.8 in /usr/local/lib/python3.12/dist-packages (from tensorboard~=2.19.0->tensorflow->-r requirements.txt (line 1)) (3.10)\n",
            ...
            "Requirement already satisfied: werkzeug>=1.0.1 in /usr/local/lib/python3.12/dist-packages (from tensorboard~=2.19.0->tensorflow->-r requirements.txt (line 1)) (3.1.4)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "mYtNFUGDk3yt",
        "outputId": "61999314-4757-4248-e135-e4b72ff04c60"
      },
      "execution_count": 4,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wNjoGJyKlQo5",
        "outputId": "736d8e4c-c0b9-45a6-e40b-18eb1c6de0f0"
      },
      "execution_count": 5,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "sm6AODVJlQl2",
        "outputId": "2cea70e5-fff0-4c87-95ac-f2ca1983b4cf"
      },
      "execution_count": 6,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "7fQK4w2wl6fK",
        "outputId": "165d3c4b-f3b1-4052-ee2b-1567089a69f8"
      },
      "execution_count": 8,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            "text/plain": [
              "\u001b[1m Total params: \u001b[0m\u001b[38;5;34m127,813\u001b[0m (499.27 KB)\n"
            ],
            "text/html": [
              "<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\"><span style=\"font-weight: bold\"> Total params: </span><span style=\"color: #00af00; text-decoration-color: #00af00\">127,813</span> (499.27 KB)\n",
              "</pre>\n"
            ]
          },
          "metadata": {}
        },
        {
          ...
          "data": {
            "text/plain": [
              "\u001b[1m Trainable params: \u001b[0m\u001b[38;5;34m127,365\u001b[0m (497.52 KB)\n"
            ],
            "text/html": [
              "<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\"><span style=\"font-weight: bold\"> Trainable params: </span><span style=\"color: #00af00; text-decoration-color: #00af00\">127,365</span> (497.52 KB)\n",
              "</pre>\n"
            ]
          },
          "metadata": {}
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "l1s0ae4vmPkQ",
        "outputId": "a6c37236-1117-4854-e460-703e5708269c"
      },
      "execution_count": 10,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "gT10dTmLJwvX",
        "outputId": "b35c9fe1-cfbf-41d6-eb96-f0221366735f"
      },
      "execution_count": 11,
      "outputs": [
        {
